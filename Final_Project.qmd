...
a.  The way that the visualizations represent my data is very different. The exploratory visualizations from homework 2 were very simple, just a basic bar graph and linear regression. My affective visualization from homework 3 is a less obvious display of data, it is not interpret-able at first glance like my effective visualizations despite the data showing the same trends. The biggest similarity between my visualizations are the tends in data the trends visualized in my affective visualization are the same trends represented in my exploratory visualizations.The pattern of higher caffeine intake leading to higher productivity is displayed in both visualizations, along with the pattern of more hours of productivity in the library than at home. The only major differences is an increase in variables, my visualizations from homework 2 did not contain any observations from the "lab" category, but my affective visualization had lots of observations from the "lab" category showing trends of high productivity.Some of the feedback that I got during the week 9 workshop was to create an ombre effect with my colors that signify caffeine consumption. I attempted to apply this feedback, however since darker colors tend to be longer and lighter colors tend to be longer the data visualization no longer fit the screen in an asymmetric way and no longer showed the variation within my weeks so I decided not to implement this change.
