...
i. Figure 1. Predicted Distance to Forest Edge by Season
Model-predicted nest box distances to forest edge for occupied (1) and unoccupied (0) boxes in 2016 and 2019. Points show observations; dark points are predictions with 95% confidence intervals (not visible due to narrow width). Data Source: Stojanovic, Dejan et al. (2021). Do nest boxes breed the target species or its competitors? A case study of a critically endangered bird [Dataset]. Dryad. https://doi.org/10.5061/dryad.83bk3j9sb
